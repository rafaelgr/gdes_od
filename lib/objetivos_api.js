...
module.exports.postObjetivosBuscar = function (req, res){
    ...
    if (buscador == null || (buscador.nombre == null && buscador.categoriaId == null) ) {
        res.send(400, "Debe incluir en el cuerpo del mensaje un objeto 'buscador' con atributo 'nombre' o 'categoriaId'.");
    }
