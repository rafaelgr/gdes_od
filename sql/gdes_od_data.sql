...
insert  into `administradores`(`administradorId`,`nombre`,`login`,`password`,`email`) values (1,'AdministradorGH','admin','','admin@g.com'),(4,'Juan','juan','jom','juan@ghy.com');
...
insert  into `areas`(`areaId`,`nombre`) values (5,'Area 334566'),(6,'Nueva area'),(7,'Arieta 13');
...
insert  into `asg_objetivos`(`asgObjetivoId`,`asgTrabajadorId`,`objetivoId`,`asSn`,`asPorObjetivo`,`asMinNum`,`asMaxNum`,`asPesoVariable`,`asPrima`,`comentarios`) values (39,3,8,NULL,'0.00','10.00','20.00','15.00',NULL,NULL),(62,3,20,NULL,'0.00','0.00','0.00','10.00',NULL,'Vendemos ideas'),(67,2,20,NULL,'0.00','0.00','0.00','10.00',NULL,NULL),(70,3,21,NULL,'0.00','10.00','12.00','15.00',NULL,NULL),(73,2,8,NULL,'0.00','0.00','0.00','10.00',NULL,'Esta es una'),(88,3,1,NULL,'0.00','10.00','20.00','0.00','4500.00',NULL),(89,2,21,NULL,'0.00','10.00','20.00','0.00','2600.00',NULL),(90,2,1,NULL,'0.00','10.00','20.00','30.00','0.00',NULL),(135,4,12,NULL,'10.00','10.00','30.00','10.00','0.00','Esta será propagado'),(146,2,17,NULL,'10.00','1.00','2.00','99.00',NULL,NULL),(160,3,17,NULL,'10.00','1.00','2.00','99.00',NULL,NULL),(161,5,17,NULL,'10.00','1.00','2.00','99.00',NULL,NULL),(162,6,17,NULL,'10.00','1.00','2.00','99.00',NULL,NULL),(163,7,17,NULL,'10.00','1.00','2.00','99.00',NULL,NULL),(164,4,17,NULL,'10.00','1.00','2.00','99.00',NULL,NULL),(167,2,12,NULL,'10.00','10.00','30.00','10.00','0.00','Esta será propagado'),(168,3,12,NULL,'10.00','10.00','30.00','10.00','0.00','Esta será propagado'),(169,5,12,NULL,'10.00','10.00','30.00','10.00','0.00','Esta será propagado'),(170,7,12,NULL,'10.00','10.00','30.00','10.00','0.00','Esta será propagado');
...
insert  into `asg_trabajadores`(`asgTrabajadorId`,`nombre`,`trabajadorId`,`ejercicioId`,`paisId`,`unidadId`,`areaId`,`puestoId`,`fijo`,`variable`,`variableF`,`fevaluadorId`,`ievaluadorId`,`dFecha`,`hFecha`,`empresaId`) values (2,'Gonxalo pocholi [2015]',3,2,3,1,5,1,'3425.00','25.00','10.00',4,4,'2015-06-08 00:00:00','2015-06-23',2),(3,'Pepe Maravillas The Great [2015]',1,2,3,1,5,1,'14.36','25.00','3.00',3,4,'2015-06-01 00:00:00','2015-06-26',2),(4,'Maria Carvajal [2014]',4,3,3,1,6,2,'10.00','1.00','2.00',3,3,'2014-01-01 00:00:00','2014-12-31',3),(5,'Maria Orgina Poloska [2015]',6,2,3,1,5,1,'45000.00','10.00','0.00',3,3,'2015-01-30 00:00:00','2015-12-12',2),(6,'Juan García Alaman [2015]',5,2,3,3,7,1,'45000.00','10.00','0.00',3,4,'2015-01-30 00:00:00','2015-12-12',3),(7,'John Milles Steward [2015]',7,2,3,1,6,1,'42000.00','10.00','0.00',3,3,'2015-01-30 00:00:00','2015-12-12',2);
...
insert  into `categorias`(`categoriaId`,`nombre`) values (0,'Puerta acceso'),(1,'Organización'),(2,'Individual'),(3,'Funcional');
...
insert  into `colectivos`(`colectivoId`,`nombre`) values (1,'Directivos'),(3,'Mando intermedio');
...
insert  into `ejercicios`(`ejercicioId`,`nombre`,`fechaInicio`,`fechaFinal`,`porPuertaAcceso`,`porOrganizacion`,`porIndividual`,`porMinIndividual`,`porMaxIndividual`) values (2,'2015','2015-01-30 00:00:00','2015-12-12 00:00:00',0,70,30,10,20),(3,'2014','2016-03-19 00:00:00','2016-03-27 00:00:00',0,20,30,0,90);
...
insert  into `empresas`(`empresaId`,`nombre`) values (2,'LAINSA'),(3,'FALCK');
...
insert  into `evaluador_trabajador`(`evaluadorTrabajadorId`,`evaluadorId`,`trabajadorId`) values (12,3,3),(10,4,1),(9,4,3),(11,4,4);
...
insert  into `objetivos`(`objetivoId`,`nombre`,`categoriaId`,`tipoId`,`evaluadorId`) values (1,'Beneficadoss',2,2,NULL),(2,'Porcenta',1,1,NULL),(8,'Numericas',2,0,4),(9,'NSFG56',0,0,NULL),(12,'Grupo 7888',1,2,3),(16,'MONHJDJ',0,2,NULL),(17,'VEN',0,1,NULL),(19,'Puntualidad',1,1,NULL),(20,'Objetivo funcional 1',3,0,NULL),(21,'Objetivo funcional 2',3,2,NULL);
...
insert  into `puestos`(`puestoId`,`nombre`) values (1,'Soldador'),(2,'Armero');
...
insert  into `tipos`(`tipoId`,`nombre`) values (0,'Si/No'),(1,'Porcentual'),(2,'Numérico'),(3,'Desempeño');
...
insert  into `trabajadores`(`trabajadorId`,`nombre`,`dni`,`login`,`password`,`evaluador`,`colectivoId`,`idioma`) values (1,'Pepe Maravillas The Great','455578','pepe','pepe',NULL,3,NULL),(3,'Gonxalo pocholi','45666','S-1-5-21-3077458779-297755452-906557366-1001','gonxo',1,1,NULL),(4,'Maria Carvajal','79854654','maria','maria',1,1,NULL),(5,'Juan García Alaman','2563366','juan','juan',NULL,3,NULL),(6,'Maria Orgina Poloska','78994545','poloska','ploska',NULL,1,NULL),(7,'John Milles Steward','12458','john','john',NULL,3,NULL);
...
insert  into `unidades`(`unidadId`,`nombre`) values (1,'Unidad 1'),(2,'Unidad 234'),(3,'Unidad 345');
